// api/send-missing-dynamic.js — Reinvia a chi non ha ricevuto una edizione
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.error('[send-missing-dynamic]', e);
