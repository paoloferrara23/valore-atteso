...
function buildHtml(edition) {
  ...
  function renderSection(sec, idx) {
    ...
    const bodyHtml = bodyParas.map(p =>
      `<p style="font-family:Georgia,serif;font-size:14px;color:#4C453D;font-weight:300;line-height:1.85;margin:0 0 20px;">${esc(p.trim()).replace(/\n/g, '<br>')}</p>`
    ).join('');
...
<table width="640" cellpadding="0" cellspacing="0" border="0" bgcolor="#F0EBE1" style="max-width:640px;width:100%;background:#F0EBE1;">

  <!-- PREHEADER -->
  <tr><td bgcolor="#1C1914" style="background:#1C1914;padding:7px 28px;">
  ...
  <!-- CTA -->
  <tr><td bgcolor="#1C1914" style="background:#1C1914;padding:32px 28px;text-align:center;">
  ...
  <!-- FOOTER -->
  <tr><td bgcolor="#E7DFD2" style="background:#E7DFD2;border-top:3px solid #1C1914;padding:24px 28px 0;">
        ...
        <table align="center" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
          <tr>
            <td style="padding-right:8px;">
              <a href="https://wa.me/?text=Ho%20letto%20Valore%20Atteso%2C%20la%20newsletter%20sul%20business%20del%20calcio%20europeo.%20Vale%20la%20pena%3A%20valoreatteso.com" bgcolor="#1C1914" style="display:block;background:#1C1914;color:#F4EFE6;font-family:'Courier New',monospace;font-size:9px;letter-spacing:.1em;text-transform:uppercase;padding:10px 18px;text-decoration:none;">WhatsApp &#8594;</a>
            </td>
            <td>
              <a href="mailto:?subject=Valore%20Atteso%20%23${esc(num)}%20%E2%80%94%20${encodeURIComponent(edition.title)}&body=Ti%20condivido%20l%27ultima%20edizione%20di%20Valore%20Atteso%2C%20newsletter%20sul%20business%20del%20calcio%20europeo.%0A%0AQuesta%20settimana%3A%20${encodeURIComponent(edition.title)}%0A%0AIscriviti%20gratis%3A%20valoreatteso.com" bgcolor="#F4EFE6" style="display:block;background:#F4EFE6;color:#1C1914;font-family:'Courier New',monospace;font-size:9px;letter-spacing:.1em;text-transform:uppercase;padding:10px 18px;text-decoration:none;border:1px solid #1C1914;">Email &#8594;</a>
            </td>
          </tr>
        </table>
      </td></tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr><td style="border-top:1px solid #CEC3B2;padding:14px 0 18px;text-align:center;">
        <p style="font-family:'Courier New',monospace;font-size:8.5px;color:#9A9690;letter-spacing:.04em;line-height:1.9;margin:0;">
          ...
          Contenuti prodotti con l'assistenza di sistemi di intelligenza artificiale, sotto supervisione e responsabilità editoriale umana. Fonti verificabili citate in ogni sezione.<br>
          Per cancellarti <a href="https://www.valoreatteso.com/cancella?email={{EMAIL}}" style="color:#777066;text-decoration:underline;">clicca qui</a>.
        </p>
      </td></tr>
    </table>
  </td></tr>
