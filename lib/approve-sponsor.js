    ...
    await sendGmail({
      ...
      html: `
        <div style="font-family:Arial,sans-serif;color:#1C1914;line-height:1.6">
          ...
          <p>Le opzioni di pagamento saranno mostrate direttamente nell'area privata dopo la scelta dello slot. L'area materiali si sbloccherà solo dopo la conferma manuale del pagamento.</p>
