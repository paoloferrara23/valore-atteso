...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const rows = await supabaseRequest(
      `/rest/v1/sponsor_requests?id=eq.${encodeURIComponent(requestId)}&select=id,company,contact_name,email,status,payment_status`,
      ...
      await sendGmail({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;color:#1C1914;line-height:1.6">
            ...
            <p>La disponibilità selezionata resta riservata. Le opzioni di pagamento rimangono consultabili esclusivamente nell'area privata.</p>
