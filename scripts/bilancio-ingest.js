...
- INDICATORE DI LIQUIDITA (licenze FIGC): estrai dallo stato patrimoniale consolidato due valori, da mettere in pnl: attivita_correnti = disponibilita liquide + crediti esigibili (incassabili) entro 12 mesi; passivita_correnti = debiti in scadenza entro 12 mesi (passivo a breve termine). Servono per l'indicatore di liquidita FIGC = attivita correnti / passivita correnti (soglia minima 0,7 per 2024/25 e 0,8 per 2025/26). Usa le voci esplicite del bilancio; se non chiaramente determinabili, metti null in entrambi.
