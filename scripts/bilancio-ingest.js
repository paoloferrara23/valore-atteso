...
- net_debt = Posizione Finanziaria Netta (PFN), calcolata SEMPRE come: Debiti finanziari (mutui, finanziamenti, obbligazioni/bond, debiti verso banche e altri finanziatori, leasing finanziari) MENO Disponibilita liquide (cassa, depositi bancari e postali) MENO Attivita finanziarie liquide (titoli, strumenti finanziari e crediti finanziari prontamente liquidabili). Formula: PFN = debiti finanziari - disponibilita liquide - attivita finanziarie liquide. Segno: POSITIVO = indebitamento finanziario netto; NEGATIVO = cassa netta (liquidita > debiti). Usa le voci esplicite dello stato patrimoniale / nota integrativa consolidati. NON includere i debiti commerciali o verso fornitori. Se il bilancio espone gia una PFN coerente con questa definizione, usala; altrimenti calcolala dalle voci esplicite (NON e una stima: e una somma algebrica di voci certe).
- INDICATORE DI LIQUIDITA (licenze FIGC): estrai dallo stato patrimoniale due valori, da mettere in pnl. Definizione FIGC (Indice di Liquidita = attivita correnti / passivita correnti; soglia minima 0,7 per 2024/25 e 0,8 per 2025/26). CALCOLA COSI, includendo i ratei/risconti (per i club di calcio i risconti passivi = abbonamenti e sponsor incassati in anticipo sono ingenti e vanno inclusi, altrimenti l'indice risulta gonfiato):
  attivita_correnti = crediti dell'attivo circolante ESIGIBILI ENTRO 12 MESI + attivita finanziarie che non costituiscono immobilizzazioni + disponibilita liquide + ratei e risconti attivi. (ESCLUDI le rimanenze e i crediti oltre 12 mesi.)
  passivita_correnti = debiti ESIGIBILI ENTRO 12 MESI + ratei e risconti passivi.
  Regola quote: dove una voce mostra lo split "di cui esigibili entro/oltre l'esercizio successivo" usa la quota ENTRO; dove non specificato, i crediti/debiti si intendono entro 12 mesi. Se i valori non sono chiaramente determinabili, metti null in entrambi.
...
- EBITDA (calcolo obbligatorio): ebitda = Valore della Produzione meno TUTTI i costi della produzione operativi, ESCLUSI ammortamenti e svalutazioni. I costi operativi da sottrarre sono: materie prime (costo_materie) + servizi (costo_servizi) + per godimento di beni di terzi/affitti-noleggi-leasing (affitti_noleggi) + personale (costo_personale) + oneri diversi di gestione (oneri_diversi) + accantonamenti. NON sottrarre ammortamenti ne svalutazioni. ATTENZIONE AL DOPPIO CONTEGGIO: in molti bilanci il "Totale oneri diversi di gestione" ingloba gia gli accantonamenti per rischi. Il campo oneri_diversi DEVE essere AL NETTO degli accantonamenti (solo le voci a,b,c... degli oneri), e gli accantonamenti vanno nel campo accantonamenti separato: non sommarli due volte. CONTROLLO: ebitda - ammortamenti - svalutazioni deve dare EBIT, dove EBIT = "Differenza tra valore e costo della produzione (A-B)" riportata dal bilancio; e poi EBIT + saldo gestione finanziaria + rettifiche/straordinaria - imposte deve dare l'utile del periodo. Se un passaggio non torna, ricontrolla le voci di costo (tipico errore: accantonamenti contati due volte). Calcola ebitda anche se il bilancio non lo espone esplicitamente (e una somma di voci certe, non una stima).
